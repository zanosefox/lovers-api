...
router.get('/dashboard', protect, adminAuth('admin', 'super_admin', 'server_owner', 'moderator'), adminController.getDashboardStats);
...
router.get('/reports', protect, adminAuth('admin', 'super_admin', 'server_owner', 'moderator'), adminController.getReports);
router.put('/reports/:id', protect, adminAuth('admin', 'super_admin', 'server_owner'), adminController.resolveReport);

router.get('/transactions', protect, adminAuth('admin', 'super_admin', 'server_owner'), adminController.getTransactions);
...
router.get('/posts', protect, adminAuth('admin', 'super_admin', 'server_owner'), adminController.getPosts);
